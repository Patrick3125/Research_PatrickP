...
def theory_steady_state_surfcov_1site_ads(ra,rd,nsite):
    mean = ra/float(ra+rd)
    variance = ra*rd/(nsite*(ra+rd)**2)
...
# theoretical results
[theo_mean_ss_surfcov,theo_var_ss_surfcov] = theory_steady_state_surfcov_1site_ads(ra,rd,nsite)

...
do
    ...
    do
        ...
        mpirun -np 1 $spkexe -in $spkscr -log $logfile -screen none -var seed $seed -var xhi $xhi -var yhi $yhi -var sitefile $sitefile -var ra2 $ra2 -var rd2 $rd2 -var Nstep $Nstep -var deltat $deltat &
    done
    wait
done

...
do
    ...
    do
        ...
        mpirun -np 1 $spkexe -in $spkscr -log $logfile -screen none -var seed $seed -var xhi $xhi -var yhi $yhi -var sitefile $sitefile -var ra1 $ra1 -var rd1 $rd1 -var ra2 $ra2 -var rd2 $rd2 -var Nstep $Nstep -var deltat $deltat &
    done
    wait
done
...
echo "  \"ra1\": $ra1," >> $logdir/sim_params.txt
echo "  \"rd1\": $rd1," >> $logdir/sim_params.txt

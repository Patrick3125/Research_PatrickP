...
for j in range(yhi):
    for i in range(1, xhi + 1):
        ...
        neighbors1 = list(set([n for n in neighbors1 if n is not None if n is not site1_id]))
        neighbors2 = list(set([n for n in neighbors2 if n is not None if n is not site2_id]))        

...
nskiptpt = 500              # number of initial time points to be skipped when calculating steady-state stats
...
##############################################
# compute the steady-state mean and variance #
##############################################
...
# screen output
print("\nSimulation results (nskiptpt=%d, Nrun=%d)" % (nskiptpt,Nrun))
print("1. Mean steady-state surface coverage:")
print("   %e (std err=%e)" % (mean_mean1,std_mean1))
print("   %e (std err=%e)" % (mean_mean2,std_mean2))
